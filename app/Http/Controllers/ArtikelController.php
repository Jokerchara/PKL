...
class ArtikelController extends Controller
{
    ...
    public function create()
    {
        ...
        $tag = Tag::all();
        // dd($tag);
        return view('backend.artikel.create', compact('catagory','tag'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $artikel->id_catagory = $request->id_catagory;
        // foto
    ...
    public function edit($id)
    {
        ...
        return view('backend.artikel.edit',compact('artikel','catagory','select','tag'));
    }
